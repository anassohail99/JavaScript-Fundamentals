...
//part (iv)
document.querySelector("#first-name").value = "Anas";

//part (v)
document.querySelector("#last-name").value = "Bin Sohail";
document.querySelector("#email").value = "anas.sohailabs@gmail.com";
